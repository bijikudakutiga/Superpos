        ...
        <div style={{ position: "relative", zIndex: 1, display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <svg width="42" height="42" viewBox="0 0 100 100" style={{ flexShrink: 0 }}>
              <polygon points="50,4 93,27 93,73 50,96 7,73 7,27" fill="#FFFFFF" />
              <polygon points="50,10 87,30 87,70 50,90 13,70 13,30" fill={COLORS.crimson} />
              <rect x="30" y="32" width="9" height="36" fill="#FFFFFF" />
              <rect x="45.5" y="32" width="9" height="36" fill="#FFFFFF" />
              <rect x="61" y="32" width="9" height="36" fill="#FFFFFF" />
            </svg>
            <div>
...
function generatePOPdf(po, supplier, company) {
  const doc = new jsPDF();
  ...
  doc.setFontSize(15);
  doc.text(company.name || "NAMA PERUSAHAAN", 14, 16);
  doc.setFont("helvetica", "normal");
  doc.setFontSize(9);
  doc.text(company.address || "-", 14, 21);
  doc.text(`${company.phone || "-"} | ${company.email || "-"}`, 14, 26);
